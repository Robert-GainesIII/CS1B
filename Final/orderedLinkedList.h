...
public:
    ...
    void deleteNode(const Type& deleteItem);
      ...
      //               head points to the head node of the 
      //               new list, and count is decremented by 1.
      //               If deleteItem is not in the list, an
      //               appropriate message is printed.
	  
	 void editNode(const Type& searchItem, const Type& editItem);
...
bool orderedLinkedList<Type>::search(const Type& searchItem) const
{
    ...
    current = head;  //start the search at the head node
...
template <class Type> 
void orderedLinkedList<Type>::editNode(const Type& searchItem, const Type& editItem){
