...
public:
   ...
   linkedListIterator<Type> operator++();    
     ...
     //Postcondition: The iterator is advanced to the link 
     //               node.
...
public:
    ...
    virtual void deleteNode(const Type& deleteItem) = 0;
	 ...
	 virtual void editNode(const Type& searchItem, const Type& editItem) = 0;
...
void linkedListType<Type>::destroyList()
{
    ...
    while (head != NULL)   //while there are nodes in the list
    {
        ...
        head = head->link; //advance head to the link node
                   ...
                   (const linkedListType<Type>& otherList) 
{
    ...
    else
    {
        ...
        head->link = NULL;        //set the link field of 
                                   //the node to NULL
        ...
        while (current != NULL)
        {
            ...
            newNode->link = NULL;       //set the link of 
                                        //newNode to NULL
            tail->link = newNode;  //attach newNode after tail
